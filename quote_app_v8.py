...
st.title("🚚 EPIG Quote Finder — v8 (MVR Age removed)")
...
# MVR Age field REMOVED from sidebar
...
# Set default MVR age internally to 30 days to satisfy carriers that require a freshness threshold
...
if submitted:
    ...
    st.caption("MVR Age removed from intake. App uses a safe default of 30 days internally for carriers that require a recent MVR.")
