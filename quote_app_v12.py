...
st.title("🚚 EPIG Quote Finder — v12 (Gooseneck + Age of Equipment)")
...
def evaluate_carrier(carrier, rules_df, inputs):
    ...
    # NEW: Age of equipment decline for specific carriers
...
# Trailer choices updated with gooseneck
...
if submitted:
    ...
    st.caption("Added Gooseneck trailer and Equipment Age. Cover Whale, Nirvana, Bulldog, and Southwind decline if older than 20 years.")
