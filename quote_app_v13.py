...
st.title("🚚 EPIG Quote Finder — v13 (Nirvana state appetite enforced)")
...
NIRVANA_STATES = {"az","ga","il","in","ia","mi","mo","nv","nc","sc","oh","pa","tn","wi"}  # lowercase to match norm()
...
# Age of Equipment
age_label = st.sidebar.selectbox("Age of Equipment", ["Newer than 20 years", "Older than 20 years"])
...
if submitted:
    ...
    st.caption("Nirvana now hard-declines outside approved states. Older-than-20 equipment declines for Cover Whale, Nirvana, Bulldog, Southwind. GEICO/Progressive accept all vehicle types; Cover Whale requires 2+ yrs exp.")
