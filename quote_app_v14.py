...
st.title("🚚 EPIG Quote Finder — v14 (CW Cargo-Van decline, GEICO state list, CA rule)")
...
if submitted:
    ...
    st.caption("Rules: CW cargo-van decline; GEICO whitelist & CA block; Progressive blocked in CA; Nirvana states enforced; >20 yrs decline for CW/Nirvana/Bulldog/Southwind; GEICO/Progressive accept all vehicle types; CW 2+ yrs exp required.")
